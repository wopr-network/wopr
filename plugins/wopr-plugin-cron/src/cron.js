...
export function shouldRunCron(schedule, date) {
    try {
...
export function createOnceJob(time, session, message) {
 ...
 */
export async function executeCronScript(script) {
 ...
 */
export async function executeCronScripts(scripts) {
    const results = [];
 ...
 */
export function resolveScriptTemplates(message, results) {
