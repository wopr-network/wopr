...
const FIXTURE_MANIFEST = {
  name: "Discord",
  description: "Connect your bot to Discord",
  author: "wopr-network",
  icon: "discord",
  color: "#5865F2",
  tags: ["channel"],
...
const FIXTURE_PLUGINS = [
  {
    ...
    npmPackage: "@wopr-network/wopr-plugin-discord-channel",
    version: "1.0.0",
    enabled: true,
    featured: false,
    sortOrder: 0,
    ...
    installedAt: null,
    installError: null,
    manifest: { ...FIXTURE_MANIFEST, name: "Discord", tags: ["channel"] },
  },
  {
    pluginId: "wopr-plugin-discord",
  ...
  },
  {
    ...
    npmPackage: "@wopr-network/wopr-plugin-slack-channel",
    version: "1.0.0",
    enabled: true,
    featured: false,
    sortOrder: 2,
    ...
    installedAt: null,
    installError: null,
    manifest: { ...FIXTURE_MANIFEST, name: "Slack Channel", tags: ["channel"] },
  },
  {
    pluginId: "wopr-plugin-analytics",
    npmPackage: "@wopr-network/wopr-plugin-analytics",
    version: "1.0.0",
    enabled: true,
    featured: false,
    sortOrder: 3,
  ...
  {
    pluginId: "wopr-plugin-voice",
    npmPackage: "@wopr-network/wopr-plugin-voice",
    version: "1.0.0",
    enabled: true,
    featured: false,
    sortOrder: 3,
    ...
    manifest: {
      ...FIXTURE_MANIFEST,
      name: "Voice",
      description: "Add voice to your bot",
      tags: ["voice"],
      capabilities: ["voice"],
    },
  },
...
vi.mock("../../fleet/services.js", () => ({
  getMarketplacePluginRepo: vi.fn(() => ({
    findEnabled: vi.fn(async () => FIXTURE_PLUGINS),
    findById: vi.fn(async (id: string) => FIXTURE_PLUGINS.find((p) => p.pluginId === id)),
  })),
