...
instancesRouter.get(
  ...
  describeRoute({
    ...
    responses: {
      200: { description: "Paginated list of instances" },
...
instancesRouter.delete(
  ...
  describeRoute({
    ...
    responses: {
      ...
      404: { description: "Instance not found" },
      409: { description: "Cannot delete a running instance" },
      401: { description: "Unauthorized" },
    },
  }),
  (c) => {
...
instancesRouter.post(
  ...
  describeRoute({
    ...
    responses: {
      ...
      404: { description: "Instance not found" },
      409: { description: "Instance already running" },
      401: { description: "Unauthorized" },
    },
  }),
  (c) => {
...
instancesRouter.post(
  ...
  describeRoute({
    ...
    responses: {
      200: { description: "Instance restarted" },
      404: { description: "Instance not found" },
      409: { description: "Cannot restart in current state" },
      401: { description: "Unauthorized" },
    },
  }),
  (c) => {
...
instancesRouter.get(
  ...
  describeRoute({
    ...
    responses: {
      200: { description: "Instance log entries" },
      404: { description: "Instance not found" },
      401: { description: "Unauthorized" },
    },
  }),
