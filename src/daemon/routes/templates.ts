...
templatesRouter.get(
  ...
  describeRoute({
    tags: ["Templates"],
    summary: "List all instance templates",
    responses: {
      200: { description: "List of built-in and custom templates" },
...
templatesRouter.post(
  ...
  describeRoute({
    ...
    responses: {
      ...
      400: { description: "Validation error or template already exists" },
      401: { description: "Unauthorized" },
    },
  }),
  async (c) => {
...
templatesRouter.post(
  ...
  describeRoute({
    tags: ["Templates"],
    summary: "Apply a template to an instance",
    responses: {
      200: { description: "Template applied to instance" },
      400: { description: "Invalid body" },
      404: { description: "Template or instance not found" },
      401: { description: "Unauthorized" },
    },
  }),
  async (c) => {
