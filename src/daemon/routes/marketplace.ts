...
marketplaceRouter.get(
  ...
  describeRoute({
    ...
    responses: {
      200: { description: "Paginated list of available plugins" },
  ...
  async (c) => {
    ...
    for (const p of installed) {
      ...
      if (
        ...
        !manifest?.description?.includes(query)
      )
        continue;
...
marketplaceRouter.get(
  ...
  describeRoute({
    ...
    responses: {
      200: { description: "Full plugin manifest and requirements" },
...
marketplaceRouter.get(
  ...
  describeRoute({
    ...
    responses: {
      200: { description: "Plugin configuration schema for dynamic UI generation" },
      404: { description: "Plugin not found" },
      401: { description: "Unauthorized" },
    },
  }),
